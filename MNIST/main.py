...
def save_state(expt_no, model, acc):
    ...
    torch.save(state, './MNIST/Experiment/' + type + '_' + str(expt_no) + '.pth.tar')
...
if __name__ == '__main__':
    ...
    filename = './MNIST/ExpData/' + '_' + type + '.txt'
    ...
    for i in range(expt_num):
        ...
        if not args.pretrained:
            ...
            pretrained_model = torch.load('./MNIST/Experiment/' + type + '.pth.tar')
