...
from BinarizedModules import BinResNetSNPConv2d
...
def conv3x3(in_planes, out_planes, stride=1):
    ...
    return BinResNetSNPConv2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=1, bias=False)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        m = OrderedDict()
        m['binconv1'] = conv3x3(inplanes, planes, stride)
        m['binconv2'] = conv3x3(planes, planes)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        m = OrderedDict()
        m['binconv1'] = BinResNetSNPConv2d(inplanes, planes, kernel_size=1, bias=False)
        m['binconv2'] = BinResNetSNPConv2d(planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        m['binconv3'] = BinResNetSNPConv2d(planes, planes * 4, kernel_size=1, bias=False)
        self.group1 = nn.Sequential(m)
