...
def conv3x3(in_planes, out_planes, stride=1):
    ...
    return BinResNetConv2d(in_planes, out_planes, kernel_size=3, stride=stride, padding=1, bias=False)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        m['binconv2'] = conv3x3(planes, planes, is_relu=False)
...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        m = OrderedDict()
        m['binconv1'] = BinResNetConv2d(inplanes, planes, kernel_size=1, bias=False)
        m['binconv2'] = BinResNetConv2d(planes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        m['binconv3'] = BinResNetConv2d(planes, planes * 4, kernel_size=1, bias=False, is_relu=False)
        self.group1 = nn.Sequential(m)
